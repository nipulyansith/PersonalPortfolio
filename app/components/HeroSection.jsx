...
const HeroSection = () => {
  return (
    ...
    />
                ...
                I’m an Information Systems (Hons) undergraduate at the University of Colombo School of Computing with a passion for developing innovative software solutions. Skilled in Next.js, React Native, Express, Node, and more, I’ve worked on projects like ParkEase and GoviSaviya. I'm seeking opportunities to further apply my skills in a software engineering role and contribute to impactful digital transformation projects.</p>
                <div>
                    <button className='w-full sm:w-fit px-6 py-3 font-medium rounded-full mr-4 text-white bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 bg-white hover:bg-slate-200 '>Hire Me</button>
